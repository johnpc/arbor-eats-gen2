<template>
  <div id="MainLayout" class="h-screen">
    ...
    >
      ...
      >
        <button @click="navigateTo('/feed')" class="w-full h-full">
          <Icon
        ...
        <button @click="navigateTo('/create')" class="w-full h-full">
          <Icon
            class="mb-1"
        ...
        <button @click="navigateTo('/settings')" class="w-full h-full">
          <Icon
            class="mb-1"
